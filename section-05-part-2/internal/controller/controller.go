...
type UseCase interface {
	...
	ChangePassword(ctx context.Context, req *entity.ChangePasswordRequest, user *entity.SelfRequest) (*entity.ChangePasswordResponse, error)
}
...
func (h *Handler) ChangePassword(c echo.Context) error {
	...
	resp, err := h.uc.ChangePassword(context.TODO(), &req, &selfReq)
	if err != nil {
		return err
	}
	return c.JSON(http.StatusOK, resp)
