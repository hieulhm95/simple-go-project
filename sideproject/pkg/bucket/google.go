...
func MustNewGoogleStorageClient(ctx context.Context, bucketName, credentialsFile string, gcsHost string) *GoogleStorageClient {
...
func (c *GoogleStorageClient) SaveImage(ctx context.Context, fileName string, fileReader io.Reader) (string, error) {
	...
	return hostDomain + "/" + bucketName + "/" + fileName, nil
}
